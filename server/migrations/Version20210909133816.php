 ...
 */
final class Version20210909133816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE skills CHANGE category category LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE sub_category sub_category TINYTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }
